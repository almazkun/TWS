...
class LoanProgram(models.Model):
    ...
    loan_min = models.PositiveIntegerField(verbose_name="Lowest Loan Possible", default=0)
    loan_max = models.PositiveIntegerField(verbose_name="Highest Loan Possible", default=0)
    borrower_age_min = models.PositiveIntegerField(verbose_name="Youngest Possible", default=0)
    borrower_age_max = models.PositiveIntegerField(verbose_name="Oldest Possible", default=0)
...
class LoanBorrower(models.Model):
    IIN = models.CharField(verbose_name="Individual Identification Number", max_length=12)
